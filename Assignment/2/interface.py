...
button_A = Button(root, border=0, image=goat_image, command=click).grid(row=0,column=0)
button_B = Button(root, border=0, image=goat_image, command=click).grid(row=4,column=0)
button_C = Button(root, border=0, image=goat_image, command=click).grid(row=2,column=3)
button_D = Button(root, border=0, image=default_image, command=click).grid(row=0,column=5)
button_E = Button(root, border=0, image=default_image, command=click).grid(row=4,column=5)
button_F = Button(root, border=0, image=tiger_image, command=click).grid(row=2,column=7)
button_G = Button(root, border=0, image=default_image, command=click).grid(row=0,column=9)
button_H = Button(root, border=0, image=default_image, command=click).grid(row=4,column=9)
